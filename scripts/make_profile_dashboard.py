...
badges_str = """
  <!-- Badge: RAG — aligned to Stack row (local y=120 → absolute y=135) -->
  <g transform="translate(855, 108)">
    ...
    <line x1="0" y1="12" x2="-30" y2="12" stroke="#00f0ff" stroke-width="0.8" stroke-dasharray="2 3"/>
  </g>
  
  <!-- Badge: LLMs — aligned to AI row (local y=145 → absolute y=160) -->
  <g transform="translate(855, 145)">
    ...
    <line x1="0" y1="12" x2="-30" y2="12" stroke="#9d00ff" stroke-width="0.8" stroke-dasharray="2 3"/>
  </g>

  <!-- Badge: LangGraph — aligned to Location row (local y=220 → absolute y=235) -->
  <g transform="translate(840, 223)">
    ...
    <line x1="0" y1="12" x2="-30" y2="12" stroke="#ff007f" stroke-width="0.8" stroke-dasharray="2 3"/>
  </g>

  <!-- Badge: AWS Basics — at prompt area (local y=280 → absolute y=295) -->
  <g transform="translate(770, 278)">
    ...
    <line x1="0" y1="12" x2="-30" y2="12" stroke="#ffaa00" stroke-width="0.8" stroke-dasharray="2 3"/>
  </g>
"""
